// filename: collection_printer.dart
...
class CollectionPrinter {
  static Future<void> printFormData(
    ...
    try {
      ...
      await SunmiPrinter.printText('Collections $tabName \n Details',
      ...
      // Print the QR code (only containing the sOrderId)
      ...
      dev.log('Finished printing form data', name: 'CollectionPrinter');
    } catch (e) {
      dev.log('Error printing: $e', name: 'CollectionPrinter');
